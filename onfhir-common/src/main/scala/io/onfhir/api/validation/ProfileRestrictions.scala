 ...
 *
 * @param short      Short description of the element
 * @param definition Formal definition of the element
 * @param comment    Comments for this element
 */
case class ElementMetadata(short: Option[String], definition: Option[String], comment: Option[String])
