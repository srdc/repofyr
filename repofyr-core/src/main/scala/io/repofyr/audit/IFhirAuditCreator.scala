package io.repofyr.audit

import io.onfhir.api.model.{FHIRRequest, FHIRResponse, HttpStatus}
...
trait IFhirAuditCreator {
  ...
  /**
    ...
    * @return
    */
  protected def resolveAuditEventOutcomeDescription(sc:HttpStatus):String = {
    sc.value
  }
  ...
  /**
    ...
    * @return
    */
  protected def resolveAuditEventOutcomeCode(statusCode: HttpStatus):String = {
  ...
  def createAuditResourcesForBatchTransaction(fhirRequest: FHIRRequest,
                                             ...
                                             statusCode: HttpStatus):Seq[Resource] = {
