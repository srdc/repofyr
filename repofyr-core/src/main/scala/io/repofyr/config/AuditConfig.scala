...
class AuditConfig(val auditConfig:Config) {
   ...
   * - 'custom' -> means a custom auditing mechanism will be used. For this, you need to provide a custom module implementing io.repofyr.audit.ICustomAuditHandler and register it to OnFhir.
   */
