...
import io.repofyr.api.service.OnFhirInternalApiService
import io.repofyr.authz.AuthManager
import io.repofyr.util.InternalJsonMarshallers._
/**
...
trait OnFhirInternalEndpoint {
  ...
  val onFhirInternalRoutes:Route = {
