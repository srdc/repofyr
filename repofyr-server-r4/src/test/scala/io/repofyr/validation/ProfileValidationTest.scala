...
class ProfileValidationTest extends Specification {
  var dataTypeProfileResources = IOUtil.readStandardBundleFile(OnfhirConfig.fhirInitializationSettings.baseDefinitionsPath, DEFAULT_RESOURCE_PATHS.BASE_DEFINITONS_R4, "profiles-types.json", Set("StructureDefinition"))
  var resourceProfileResources = IOUtil.readStandardBundleFile(OnfhirConfig.fhirInitializationSettings.baseDefinitionsPath, DEFAULT_RESOURCE_PATHS.BASE_DEFINITONS_R4, "profiles-resources.json", Set("StructureDefinition"))
  ...
  val otherProfiles = IOUtil.readStandardBundleFile(OnfhirConfig.fhirInitializationSettings.baseDefinitionsPath, DEFAULT_RESOURCE_PATHS.BASE_DEFINITONS_R4, "profiles-others.json", Set("StructureDefinition")).map(sdParser.parseProfile)
  val extensions = IOUtil.readStandardBundleFile(OnfhirConfig.fhirInitializationSettings.baseDefinitionsPath, DEFAULT_RESOURCE_PATHS.BASE_DEFINITONS_R4, "extension-definitions.json", Set("StructureDefinition")).map(sdParser.parseProfile)

  val valueSetsOrCodeSystems =
    IOUtil.readStandardBundleFile(OnfhirConfig.fhirInitializationSettings.baseDefinitionsPath, DEFAULT_RESOURCE_PATHS.BASE_DEFINITONS_R4,"valuesets.json", Set("ValueSet", "CodeSystem")) ++
      IOUtil.readStandardBundleFile(OnfhirConfig.fhirInitializationSettings.baseDefinitionsPath, DEFAULT_RESOURCE_PATHS.BASE_DEFINITONS_R4,"v3-codesystems.json", Set("ValueSet", "CodeSystem")) ++
      IOUtil.readStandardBundleFile(OnfhirConfig.fhirInitializationSettings.baseDefinitionsPath, DEFAULT_RESOURCE_PATHS.BASE_DEFINITONS_R4,"v2-tables.json", Set("ValueSet", "CodeSystem"))
